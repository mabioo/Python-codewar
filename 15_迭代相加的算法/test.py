...
# in K rows and N columns as a kind of 2D matrix K x N where K and N are 
# postive integers. 
# 
# He thinks that his calculations show that the force exerted by the 
# particle 
# in the small box (k, n) is:
